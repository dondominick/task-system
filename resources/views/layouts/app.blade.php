...
<head>
    ...
    <style>
        nav {
            ...
            background: linear-gradient(90deg, rgba(3, 79, 1, 1) 37%, rgba(0, 19, 0, 1) 100%);
            border: none;
        }
        ...
        .bg-gradient-green {
            background: rgb(3, 79, 1);
            background: linear-gradient(189deg, rgba(0, 65, 0, 1) 31%, rgba(0, 0, 0, 1) 94%);
        }
...
<body class="font-sans antialiased">
    ...
    <nav class="fixed z-50 w-full min-h-[80px] bg-white border-b border-gray-200 dark:bg-gray-800 dark:border-gray-700">
            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center justify-start rtl:justify-end">
                    ...
                    <a href="https://flowbite.com" class="flex ms-2 md:me-24">
                        <img src="{{ asset('assets/images/logo.png') }}" class="max-h-[50px]"
                    ...
                    <div class="flex items-center ms-3">
                        <div class="flex gap-5 items-center">
                            ...
                            <button type="button"
                                ...
                                <img class="w-8 h-8 rounded-full" src="{{ asset('assets/images/profile.jpg') }}"
                                    alt="user photo">
                            </button>
    ...
    <div class="flex bg-gray-200 top-[80px] fixed w-full min-h-screen">

        <aside id="basis-1/5 fixed"
                ...
                <ul class="space-y-2 font-medium">
                    ...
                    <li>
                        <a href="{{ route('leave') }}"
                            ...
                            <span class="flex-1 ms-3 whitespace-nowrap">File Leave</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('inbox') }}"
        ...
        <form hidden id="logoutForm" action="{{ route('logout') }}" method="POST">
            @csrf
        </form>
        ...
        <!-- Page Content -->
        <main class="basis-4/5 bg-gray-200 max-h-screen overflow-y-scroll p-4 pb-[150px]">
            @yield('content')
        </main>
