...
@section('content')
    <div class=" m-5 py-2 font-extrabold">
        <h1 class="text-4xl">Leave Request</h1>
    </div>

    {{-- ERROR --}}

    @error('request')
        <div class="flex items-center mx-auto max-w-[900px] p-4 mb-4 text-sm text-red-800 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400"
            role="alert">
    ...
    <div
        class="
      shadow-md shadow-green-800/100 font-medium rounded-xl 
    max-w-[900px] mx-auto  bg-white shadow-green p-1 min-h-[300px]">
        <form class="p-2 py-3" method="post" action="{{ route('create-leave') }}" enctype="multipart/form-data">
            @csrf
            ...
            <div id="date-range-picker" date-rangepicker class="flex items-center mx-auto mb-5">
                ...
                <div class="relative">
                    ...
                    <input id="datepicker-range-start" name="start_date" type="text" value="{{ old('start_date') }}"
                ...
                <div class="relative">
                    ...
                    <input id="datepicker-range-end" name="end_date" type="text" value="{{ old('end_date') }}"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
